            ...
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                 ...
                 <a href="index.php" class="brand-logo" > 
                    <img width="250" height="100" src="ini.png" alt="logo">
                </a>
            </div>
            <!-- /.navbar-header -->
                            ...
                            <div class="asset-inner">
                                <table>
                                    ...
                                    <?php
                                        ...
                                        $total_pages_sql = "SELECT COUNT(*) FROM artikel1";
                                        $result = mysqli_query($koneksi,$total_pages_sql);
                                        $total_rows = mysqli_fetch_array($result)[0];
                                        $total_pages = ceil($total_rows / $no_of_records_per_page);

                                        $sql = "SELECT * FROM artikel1 LIMIT $offset, $no_of_records_per_page";
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo substr($deskripsi, 0,30); echo "...."; ?></td>
